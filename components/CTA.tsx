export default function CTA() {
  return (
    <section
      id="contact"
      className="py-20 bg-gradient-to-br from-[#1d6fe8] to-[#0f1f3d] text-white"
    >
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-blue-100 text-lg leading-relaxed mb-10">
          Neem direct contact op voor advies, een reparatie of een offerte op
          maat. Wij staan klaar om u te helpen met vakmanschap en snelle service.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-[#25D366] text-white font-semibold px-6 py-3.5 rounded-lg hover:bg-[#1ebe5d] transition-colors text-sm"
          >
